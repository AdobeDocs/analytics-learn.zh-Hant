...
* 說明如何在 Analysis Workspace 中建立專案、自由格式表格和視覺效果的範例。
* 留出時間進行問答。
...
每個部門通常會有一個使用者在 Adobe Analytics 方面擁有更先進且更淵博的知識。 善用他們的專業知識並與其合作，使其成為「Adobe Analytics部門負責人」。 透過建立這種支援等級，您就是在幫助使用者提升技能，讓貴組織在Adobe Analytics中投入更多資金，並讓您有時間解答更進階且有挑戰性的問題。
