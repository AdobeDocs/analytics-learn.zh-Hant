...
*選擇啟用CDA的基底（來源） [!UICONTROL 報告套裝]*
![[!UICONTROL 虛擬報表套裝]步驟1](assets/cda-vrs-step-one.png)

然後開啟[!UICONTROL 報告時間處理]並啟用[!UICONTROL 跨裝置銜接]：

*啟用[!UICONTROL 報告時間處理]和[!UICONTROL 跨裝置銜接]*
![[!UICONTROL 虛擬報表套裝]步驟二](assets/cda-vrs-step-two.png)

完成 VRS 設定並儲存。 CDA VRS 將在 Analysis Workspace 中顯示，旁邊會出現特殊圖示，如下所示：

*在Analysis Workspace中選取CDA VRS*
![[!UICONTROL 虛擬報表套裝]步驟三](assets/cda-vrs-step-three.png)
...
>[!NOTE]
>
>由於可以重述記錄，因此這表示您的資料在啟用 CDA 的[!UICONTROL 虛擬報告套裝]中可能隨著時間變更。 當您傳達以 CDA 為基礎的分析的洞察時，請將此謹記在心。
...
*個人層級區段*
![[!DNL Segment Builder] [!UICONTROL 人員]容器](assets/cda-segment-builder-person-container.png)
...
*個人型對象分析*
![文氏圖表和長條圖](assets/cda-venn-and-histogram.png)
