...
**A.** 計算量度的名稱。 此名稱會顯示在量度元件清單中，因此對自己和其他人而言是清楚的，例如&#x200B;*客服中心AOV*。
...
1. **檢查您的公式語法。** 請確認公式語法正確且遵循Adobe Analytics語法，確保您取得有意義的資訊。
...
1. **確定您的資料是最新的。** 請務必在區段定義中使用精確且最新的資料，以取得準確的結果。
