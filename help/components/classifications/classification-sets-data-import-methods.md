---
title: 分類集資料匯入方法
description: 了解使用分類集匯入分類資料的各種方法，以及相關的使用案例。
...
了解使用分類集匯入分類資料的各種方法，以及相關的使用案例。

>[!VIDEO](https://video.tv.adobe.com/v/3475839/?captions=chi_hant&learn=on&enablevpops)

如需詳細資訊，請查看[文件](https://experienceleague.adobe.com/zh-hant/docs/analytics/components/classifications/sets/overview){target="_blank"}。
